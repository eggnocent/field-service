...
import (
	...
	repository "field-service/repositories"
)

type TimeService struct {
	repository repository.IRepositoryRegistry
}
...
func NewTimeService(repository repository.IRepositoryRegistry) ITimeService {
